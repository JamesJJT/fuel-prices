...
use App\Dto\FuelDtos\UK\MotorFuelGroupDto;
use App\Services\Fuel\FuelProviderInterface;

class MotorFuelGroupService implements FuelProviderInterface
{
    protected string $url = 'https://fuel.motorfuelgroup.com/fuel_prices_data.json';
