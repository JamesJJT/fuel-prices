...
use App\Dto\FuelDtos\UK\SgnDto;
use App\Services\Fuel\FuelProviderInterface;

class SgnService implements FuelProviderInterface
{
    protected string $url = 'https://www.sgnretail.uk/files/data/SGN_daily_fuel_prices.json';
